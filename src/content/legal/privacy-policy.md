...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Miners Online.
...
- __Website__ refers to Miners Online, accessible from [https://minersonline.tk](https://minersonline.tk)
...
- __Tracking and Analytics Cookies__

	Type: Persistent Cookies

	Administered by: Us

	Purpose: These Cookies allow us to track the activity on Our Service and store certain information to improve and analyze Our Service. These Cookies are shared to following Third-party Services:

	- Google

	The Third-party Services are used by us to have a better understanding of how You use the Website, the data collected by the Cookies are sent to Third-party Services and is under the terms of the Third-party's Privacy Policy. No peronally identifiable about You will be sent to Third-parties.
